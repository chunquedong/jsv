...
public class Validate {
	...
	public Validate email(String text, String msg)
  {
    ...
    if (!isEmail(text))
    	throw new ValidateException(msg != null ? msg : "Not a valid email: "+text);
    return this;
  }
	...
	public Validate digit(String text, String msg)
  {
    if (text.isEmpty()) return this;
    if (!isDigit(text))
    	throw new ValidateException(msg != null ? msg : "Not a valid digit: "+text);
    return this;
  }
	...
	public Validate date(String text, String msg)
  {
    if (text.isEmpty()) return this;
    if (!isDate(text))
    	throw new ValidateException(msg != null ? msg : "Not a valid date: "+text);
    return this;
  }
	...
	public Validate uri(String text, String msg)
  {
    if (text.isEmpty()) return this;
    if (!isUri(text))
    	throw new ValidateException(msg != null ? msg : "Not a valid uri: "+text);
    return this;
  }
	...
	public Validate identifier(String text, String msg)
  {
    ...
    if (!isIdentifier(text))
    	throw new ValidateException(msg != null ? msg : "Not a valid identifier: "+text);
    return this;
  }
